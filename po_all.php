...
<body class="text-gray-800 font-inter">
    ...
    <div class="p-6">
        <div class="grid grid-cols-1 gap-6 mb-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="flex justify-between mb-6">
                    <div>
                        <div class="flex items-center mb-1">
                            <div class="text-2xl font-semibold">Rs. <?php echo number_format($approvedAmount); ?></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-6 bg-white border border-gray-100 rounded-md shadow-md shadow-black/5">
                <div class="flex justify-between mb-6">
                    <div>
                        <div class="flex items-center mb-1">
                            <div class="text-2xl font-semibold"><?php echo $counts['approved']; ?></div>
                        </div>
                    </div>
                </div>
        ...
        <div class="p-6 bg-white border border-gray-100 rounded-md shadow-md shadow-black/5 lg:col-span-2">
            <div class="font-medium">All Purchase Orders</div>
            <br>
                ...
                <table class="w-full text-center table-auto min-w-max">
                    ...
                    <tbody>
                        <?php foreach ($rows as $index => $row): ?>
                            ...
                            // Determine the status based on REQ_PO_STS
                            switch ($row['REQ_PO_STS']) {
                                case '002':
                                    $status = 'Approved';
                            ...
                            <tr>
                                ...
                                <td class="p-4 border-b border-blue-gray-50">
                                    <div class="w-max">
                                        <div class="relative grid items-center px-2 py-1 font-sans text-xs font-bold uppercase rounded-md select-none whitespace-nowrap <?php echo $statusColor; ?>" style="opacity: 1;">
