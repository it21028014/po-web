...
include './Query/approve_query.php';
...
if ($userRole === 'MGR' && basename($_SERVER['PHP_SELF']) !== 'dashboard.php') {
    header('Location: dashboard.php'); // Redirect MGR to their dashboard
    exit;
} elseif ($userRole === 'EXE' && basename($_SERVER['PHP_SELF']) !== 'executive_dashboard.php') {
    header('Location: executive_dashboard.php'); // Redirect EXE to their dashboard
    exit;
} elseif ($userRole === 'ADMIN' && basename($_SERVER['PHP_SELF']) !== 'admin_dashboard.php') {
...
<head>
    ...
    <title>Approved POs</title>
</head>

<body class="text-gray-800 font-inter">
    <?php
    include './excutive/exe-nav.php';
    ?>
    <!-- Content -->
    <div class="p-6">
