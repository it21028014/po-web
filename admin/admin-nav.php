...
<body>
    ...
    <div class="fixed left-0 top-0 w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu transition-transform">
        ...
        <ul class="mt-4">
            ...
            <li class="mb-1 group">
                <a href="admin_dashboard.php" class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
            ...
            <li class="mb-1 group">
                <a href="../manager_web/create_user.php" class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
            ...
            <li class="mb-1 group">
                <a href="../manager_web/create_user.php" class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                    ...
                    <span class="text-sm">Branch List1</span>
                </a>
            </li>
                ...
                <li class="ml-3 dropdown">
                    <button type="button" class="flex items-center dropdown-toggle">
                        ...
                        <div class="p-2 text-left md:block">
                            ...
                            <p class="text-xs text-gray-500">Administrator - <?php echo htmlspecialchars($branchCode); ?></p>
                        </div>
                    </button>
