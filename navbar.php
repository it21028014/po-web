...
<body>
    ...
    <div class="fixed left-0 top-0 w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu transition-transform">
        ...
        <ul class="mt-4">
            <span class="font-bold text-gray-400">Manager</span>
            <li class="mb-1 group">
            ...
            <li class="mb-1 group">
                ...
                <ul class="pl-7 mt-2 hidden group-[.selected]:block">
                    ...
                    <li class="mb-4">
                        <a href="./po_approve.php" class="text-gray-900 text-sm flex items-center hover:text-[#b878ec] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Approved POs</a>
                    </li>
                    <li class="mb-4">
                        <a href="./po_pending.php" class="text-gray-900 text-sm flex items-center hover:text-[#b878ec] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Pending POs</a>
                    </li>
                    <li class="mb-4">
                        <a href="./po_cancel.php" class="text-gray-900 text-sm flex items-center hover:text-[#b878ec] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Cancelled POs</a>
                    </li>
            ...
            <li class="mb-1 group">
                <a href="./po_all.php" class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                    <i class='mr-3 text-lg bx bx-list-ul'></i>
                    <span class="text-sm">All Purchase Orders</span>
                </a>
            </li>
        </ul>
    </div>
        ...
        <div class="py-2 px-6 bg-[#f8f4f3] flex items-center shadow-md shadow-black/5 sticky top-0 left-0 z-30">
            ...
            <ul class="flex items-center ml-auto">
                <button id="fullscreen-button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="rounded-full hover:bg-gray-100" viewBox="0 0 24 24" style="fill: gray;transform: ;msFilter: ;	">
                ...
                <li class="ml-3 dropdown">
                    <button type="button" class="flex items-center dropdown-toggle">
                        ...
                        <div class="p-2 text-left md:block">
                            <h2 class="text-sm font-semibold text-gray-800"><?php echo htmlspecialchars($officerName); ?></h2>
                            <p class="text-xs text-gray-500">Manager - <?php echo htmlspecialchars($branchCode); ?></p>
                        </div>
                    </button>
                    <ul class="dropdown-menu shadow-md shadow-black/5 z-30 hidden py-1.5 rounded-md bg-white border border-gray-100 w-full max-w-[140px]">
                        <li>
                            <a href="profile.php" class="flex items-center text-[13px] py-1.5 px-4 text-gray-600 hover:text-[#f84525] hover:bg-gray-50">Profile</a>
                        </li>

                        <li>
                            <form method="POST" action="./Query/logout.php">
